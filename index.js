...
console.log(blue("Welcome To Quiz Game.!"), yellow("How much do you know about fitness"));


var name = rs.question(cyan("Your Name? "))
console.log(green(`Hello ${name}!`));


console.log("\n! There are "+ totalQuestion +" questions with 4 option , yellow("1, 2, 3, 4"), "!\n");
...
var displayQuestion = (que) => {
  ...
  if(que.options[answer - 1] == que.answer){
    marks += 5;
    console.log(green("Right Answer!"));
  } else {
    marks -= 2;
    console.log(red("Wrong answer!"));
    console.log(yellow("Right Answer: " + que.answer));
  }
};
